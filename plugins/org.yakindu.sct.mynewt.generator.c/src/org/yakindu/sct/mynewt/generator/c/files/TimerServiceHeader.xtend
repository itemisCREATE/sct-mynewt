package org.yakindu.sct.mynewt.generator.c.files
...
class TimerServiceHeader implements IContentTemplate {
	...
	override content(ExecutionFlow it, GeneratorEntry entry, extension IGenArtifactConfigurations locations) '''
		...
		#include "«(typesModule.h).relativeTo(this.module.h)»"
